...
from utils.test_data_processing import get_data
from train.train import train_model,eval_model
from utils.my_utils import EarlyStopMonitor, set_config, Metric,save_model,load_model
...
parser.add_argument('--subtest', type=bool, default=False, help='whether to use subtest')
try:
...
final_metric = eval_model(model.to(device), dataset, device, param, metric,torch.nn.MSELoss(), move_final=True)
